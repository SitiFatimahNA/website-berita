            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900" style="text-align: center; border: 1px solid green;">
                    ...
                    <form action="{{route('admin.postupdate', $post->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <label style="background-color: #819b85;">Old Image</label>
                        <img src="{{ asset('img/' . $post->image) }}" style="width: 100px; height: 100px; margin-left: 450px; margin-bottom: 10px; " alt="{{ $post->image }}">
                        <label style="background-color: #819b85;">New Image</label>
                        <input type="file" name="image"> <br><br><br>
                        <input style="border: 1px solid green; text-align: center; padding: 10px" type="submit" name="submit" value="Update Post">
                    </form>
                </div>
            </div>
        </div>
